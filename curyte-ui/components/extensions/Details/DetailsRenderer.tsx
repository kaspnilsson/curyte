...
const DetailsWrapper = ({
  ...
  return (
    <NodeViewWrapper>
      <div className="grid grid-cols-[min-content_1fr] items-center gap-2 p-4 lg:p-8 my-4 border rounded-xl border-zinc-200">
        <IconButton
        ...
        {editor.isEditable && (
          <TextareaAutosize
            autoFocus
            className="w-full overflow-hidden text-lg font-bold leading-tight tracking-tighter border-0 resize-none"
            value={summary}
